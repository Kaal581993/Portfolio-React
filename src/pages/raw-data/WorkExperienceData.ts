...
const WorkExperienceData ={
    jobTitle:['Software Developer Trainee (Java + React Stack)', 'Technical Support Engineer','L2 Technical Support Engineer','Technical Support Executive','Customer Success Engineer','Application Support Technician'
],
    WorkHeading:['Self-Driven Projects & Freelance Work | 2024 – Present','Quest2Travel, Mumbai | Sep 2024 –  2025','eClinicalWorks, Mumbai | Jan 2022 – Mar 2024','Restolabs, Noida | Oct 2020 – Dec 2021','Contentstack Pvt. Ltd., Virar | Feb 2020 – Aug 2020','eZee Technosys Pvt. Ltd., Surat | May 2019 – Dec 2019'],
    Responsibilities:['Developed full-stack applications using Java, Spring Boot, and React.js with RESTful APIs.Built an Attendance Management System with admin login, CRUD operations, and real-time reporting using MySQL.Created a responsive E-Book Sharing Platform using HTML, CSS, and JavaScript, enabling secure file upload/download and UI interactivity.Focused on clean code, reusable components, and performance optimization during frontend development.',
                      'Provided platform-level support for an expense management system using Oracle SQL Developer.Executed advanced DML/DDL queries to troubleshoot backend logic and data integrity issues.Actively collaborated with developers to streamline issue resolution and improve SQL efficiency.',
                      ...
                      'Provided technical onboarding and incident response for Headless CMS clients via REST API monitoring.Used Jira for bug tracking, sprint follow-ups, and real-time client communication.',
...
//Provided platform-level support for an expense management system using Oracle SQL Developer.
...
//Supported U.S.-based clients with critical issues in healthcare applications, ensuring compliance with FHIR and HL7 protocols.
